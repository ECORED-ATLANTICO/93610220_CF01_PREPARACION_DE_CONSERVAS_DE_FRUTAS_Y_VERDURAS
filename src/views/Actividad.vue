    ...
    cuestionario: {
      ...
      preguntas: [
        ...
        },
        {
          ...
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Bióxido de azufre', esCorrecta: false },
            { id: 'b', texto: 'Ácido benzoico', esCorrecta: false },
            { id: 'c', texto: 'Ácido cítrico', esCorrecta: false },
            { id: 'd', texto: 'Vinagre', esCorrecta: true },
          ],
        },
        {
          id: 4,
          ...
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Pectina', esCorrecta: false },
            { id: 'b', texto: 'Carotenoides', esCorrecta: true },
            { id: 'c', texto: 'Almidón', esCorrecta: false },
            { id: 'd', texto: 'Sal', esCorrecta: false },
          ],
        },
        {
          id: 5,
        ...
        },
        {
          ...
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Limón', esCorrecta: false },
            { id: 'b', texto: 'Manzana', esCorrecta: true },
            { id: 'c', texto: 'Uva', esCorrecta: false },
            { id: 'd', texto: 'Piña', esCorrecta: false },
          ],
        },
        {
          id: 8,
          ...
          opciones: [
            ...
            { id: 'd', texto: 'Prevenir el cáncer.', esCorrecta: false },
          ],
        },
        {
          id: 9,
